...
def todaysDate():
    ...
    return date
# FILTERS STOCK BY BEING CLOSE TO 200 SMA
def main():
    ...
    real_date = (stock.final_date - delta_real)
    ...
    for i in stock_symbols:
        ...
        try:
            ...
            stock.init_date = (real_date - delta).strftime('%Y-%m-%d')       
            if (current < sma200*1.03 and current > sma200*0.97):
